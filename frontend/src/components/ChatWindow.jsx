...
export default function ChatWindow({ studentName }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontWeight: 700, fontSize: 17 }}>Claude Teacher</div>
          <div style={{ fontSize: 12, color: 'var(--text-muted)' }}>
            Here to help you learn, {studentName}!
          </div>
        </div>
      </div>
      ...
      <div style={{
        ...
        {messages.length === 0 && (
          <div style={{
            ...
            <div style={{ fontSize: 16 }}>Hi {studentName}! What are we working on today?</div>
