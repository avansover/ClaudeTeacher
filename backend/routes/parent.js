...
When writing a fraction, use {{frac|numerator|denominator}} notation (e.g. {{frac|2|7}}) — it renders as a real stacked fraction in the UI. Use it for every fraction, including inside mixed numbers (e.g. "3 {{frac|2|7}}"). Write it exactly like that, no backslash.`;
